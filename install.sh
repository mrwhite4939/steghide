...
echo ""
echo " Add me In Discord  🔔 " | lolcat
xdg-open  https://discord.com/users/1417141835960160428
echo ""
...
menu() {
sleep 0.5
printf "\e[1;97m are you want add me in discord?\e[0m"
sleep 0.5
printf "\n"
sleep 0.5
...
sleep 0.5
echo -e "\e[1;92m Press enter to view my discord\e[0m"
read a1
termux-open-url https://discord.com/users/1417141835960160428
cd $HOME
cd steghide 
rm -rf install.sh
